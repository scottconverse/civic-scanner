...
Scanner: Civic Source Scanner v1.1
```
...
- Summary stats: number of publishable stories, holds, sources checked per tier
...
**Final Package:**
- Publishable stories summary table (headline, word count, verification, legal risk, verdict)

...
export function packagePlugin(outputRoot, { force = false } = {}) {
  ...
  const manifest = {
    ...
    name: 'civic-scanner',
    version: '2.4.0',
    description: 'Source-grounded civic scan and meeting action coverage for local reporting.',
    ...
    extensions: { 'com.openai': { interface: {
      ...
      longDescription: 'Find, verify, and track substantive civic actions with a complete meeting ledger.',

...
10. **Further research:** Identify the best accessible next source, interview, site visit, or data check. Do not propose a formal records request or a fee. Record suppression reopen triggers and update writable beat memory when authorized by the run.
